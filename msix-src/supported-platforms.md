...
| [Package Integrity Enforcement for non-Store packages](package/signing-package-overview.md.md#packageintegrityenforcement) | :x: | :x: | :x: | :x:| :x: | :heavy_check_mark:| :x:| :x: | 
