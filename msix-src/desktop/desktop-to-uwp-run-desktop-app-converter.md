...
> [!NOTE]
> The Desktop App Converter tool is deprecated. We recommend that you use the [MSIX Packaging Tool](../mpt-overview.md) instead.
...
See [Run, debug, and test a packaged desktop application](https://docs.microsoft.com/windows/uwp/desktop-to-uwp-debug)
