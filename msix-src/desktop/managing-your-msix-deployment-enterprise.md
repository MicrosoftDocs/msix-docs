...
When creating an application in Microsoft Endpoint Configuration Manager, select application type: <b>Windows app package (*.appx, *.appxbundle, *.msix, *.msixbundle)</b>. For guidance on how to create and deploy an application through Microsoft Endpoint Configuration Manager visit the [create and deploy an application](https://docs.microsoft.com/configmgr/apps/get-started/create-and-deploy-an-application) Docs article.
...
Installation of an MSIX application is standardized, as such, when adding a new <b>Line-of-business app</b> to Microsoft Intune, there is no requirement to configure the silent installation parameters required for install. For guidance on how to create and deploy an application through Microsoft Intune visit the [Creating line of business apps in Intune](https://docs.microsoft.com/en-us/mem/intune/apps/lob-apps-windows) Docs article.
