...
Extract/unzip the .cab file and run the command ```Dism /Online /add-package /packagepath:(path)```. The path here is the path of the extracted or unzipped folder, and not the .cab file itself.
