...
# [App Installer](app-installer/appinstaller-root)
## [Install from web](app-installer/installing-uwp-apps-web)
### [Web Install Tutorials]()
#### [Install a UWP app from an Azure Web App](app-installer/web-install-azure)
#### [Install a UWP app from an IIS server](app-installer/web-install-iis)
#### [Hosting UWP app packages on AWS for web install](app-installer/web-install-aws)
## [AppInstaller File](app-installer/install-related-set)
## [Create App Installer file in Visual Studio](app-installer/create-appinstallerfile-vs)
## [App updates using App Installer file](app-installer/app-installer-file-update.md)
## [Troubleshoot installation issues with App Installer file](app-installer/troubleshoot-appinstaller-issues)
