---
title: Deploy MSIX Core with Microsoft Configuration Manager
...
# Deploy MSIX Core with Microsoft Configuration Manager
...
1. Deploy MSIX Core with Microsoft Configuration Manager
1. [Update your existing MSIX package to support MSIX Core](support-msix-core.md)
1. [Deploy MSIX Core Apps with Microsoft Configuration Manager](deploy-msix-core-app-with-configmgr.md)
...
The following will guide you through the creation of a Microsoft Configuration Manager application, for the purpose of deploying MSIX Core to Windows 7 devices. If you intend to push this to other versions of the Windows operating system, please alter your application requirements to target those select operating system versions.
 
### Download MSIX Core
1. Download the latest version of [MSIX Core](https://github.com/microsoft/msix-packaging/releases).
1. Move the downloaded MSIX Core (x86 / x64) installation media to a file share which is accessible by your Microsoft Configuration Manager environment.

### Create Microsoft Configuration Manager Application - MSIX Core
1. Open your Microsoft Configuration Manager Console. Navigate to **Software Library > Overview \ Application Management \ Applications.**
...
1. From within the Microsoft Configuration Manager console: **Software Library > Overview / Application Management / Applications** 
