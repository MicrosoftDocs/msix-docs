...
Apps can be installed without being published in the Store by publishing them on your Website, using application management tools such as Microsoft Intune and System Centre Config Manager, etc. You can also directly install an MSIX package for testing on your local or remote machine.

### Create an app package using the packaging izard
...
### Install your app package on Windows 10 Anniversary Update or later
...
### Install your app package on previous versions of Windows 10
...
### Next steps  - run, debug or test your app package

See [Run, debug, and test an app package](desktop-to-uwp-debug.md) for how you can debug your application in Visual Studio or using Windows debugging tools. 
