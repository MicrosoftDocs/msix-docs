...
> [!NOTE]
> * Make sure that the publisher name in the package's manifest matches the certificate you are using to sign the package. This is going to be your leaf certificate. Typically the publisher name in the manifest would be **CN=CompanyName**. Otherwise, the signing operation will fail. 
