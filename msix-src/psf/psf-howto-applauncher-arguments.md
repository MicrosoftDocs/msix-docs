...
1. [Stage the Windows App to a local directory](https://docs.microsoft.com/windows/msix/psf/psf-howto-workingdirectory-fix#State-the-Windows-App)
1. [Create the Config.json and inject required PSF Files](https://docs.microsoft.com/windows/msix/psf/psf-howto-workingdirectory-fix#Create-and-inject-required-psf-files)
1. [Update the Windows App AppxManifest file](https://docs.microsoft.com/windows/msix/psf/psf-howto-workingdirectory-fix#Update-AppxManifest)
1. [Repackage and sign the Windows App](https://docs.microsoft.com/windows/msix/psf/psf-howto-workingdirectory-fix#Re-package-the-application)
